		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getNonLeftRecExpressionAccess().getConditionAssignment_5_1(), "rule__NonLeftRecExpression__ConditionAssignment_5_1");
					put(grammarAccess.getNonLeftRecExpressionAccess().getIfBlockAssignment_5_3(), "rule__NonLeftRecExpression__IfBlockAssignment_5_3");
					put(grammarAccess.getNonLeftRecExpressionAccess().getElseBlockAssignment_5_5(), "rule__NonLeftRecExpression__ElseBlockAssignment_5_5");
					put(grammarAccess.getNonLeftRecExpressionAccess().getBindingsAssignment_6_1(), "rule__NonLeftRecExpression__BindingsAssignment_6_1");
					put(grammarAccess.getNonLeftRecExpressionAccess().getBindingsAssignment_6_2_1(), "rule__NonLeftRecExpression__BindingsAssignment_6_2_1");
					put(grammarAccess.getNonLeftRecExpressionAccess().getLetExprAssignment_6_4(), "rule__NonLeftRecExpression__LetExprAssignment_6_4");
