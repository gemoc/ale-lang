...
import fr.inria.diverse.ide.contentassist.antlr.internal.InternalXtdAQLParser;
...
public class XtdAQLParser extends AbstractContentAssistParser {
	...
	@Override
	protected InternalXtdAQLParser createParser() {
		InternalXtdAQLParser result = new InternalXtdAQLParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getRootAccess().getClassesAssignment(), "rule__Root__ClassesAssignment");
					put(grammarAccess.getClassAccess().getNameAssignment_1(), "rule__Class__NameAssignment_1");
					put(grammarAccess.getClassAccess().getMethodsAssignment_3(), "rule__Class__MethodsAssignment_3");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			InternalXtdAQLParser typedParser = (InternalXtdAQLParser) parser;
