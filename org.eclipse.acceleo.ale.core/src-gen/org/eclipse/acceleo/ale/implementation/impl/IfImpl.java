 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.acceleo.ale.implementation.impl.IfImpl#getCondition <em>Condition</em>}</li>
 *   <li>{@link org.eclipse.acceleo.ale.implementation.impl.IfImpl#getThen <em>Then</em>}</li>
 *   <li>{@link org.eclipse.acceleo.ale.implementation.impl.IfImpl#getElse <em>Else</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IfImpl extends StatementImpl implements If {
	...
	protected EClass eStaticClass() {
		return ImplementationPackage.Literals.IF;
	}
	...
	public NotificationChain basicSetElse(Block newElse, NotificationChain msgs) {
		...
		else_ = newElse;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ImplementationPackage.IF__ELSE, oldElse, newElse);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setElse(Block newElse) {
		if (newElse != else_) {
			NotificationChain msgs = null;
			if (else_ != null)
				msgs = ((InternalEObject)else_).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ImplementationPackage.IF__ELSE, null, msgs);
			if (newElse != null)
				msgs = ((InternalEObject)newElse).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ImplementationPackage.IF__ELSE, null, msgs);
			msgs = basicSetElse(newElse, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ImplementationPackage.IF__ELSE, newElse, newElse));
	}
