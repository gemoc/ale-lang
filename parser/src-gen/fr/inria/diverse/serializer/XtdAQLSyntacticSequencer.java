...
public class XtdAQLSyntacticSequencer extends AbstractSyntacticSequencer {

	protected XtdAQLGrammarAccess grammarAccess;
	...
	protected void init(IGrammarAccess access) {
		grammarAccess = (XtdAQLGrammarAccess) access;
