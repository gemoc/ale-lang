 ...
 *******************************************************************************/
package org.eclipse.acceleo.ale.core.interpreter.test;
	...
	public void testService(){
		try {
			ServiceUtils.registerServices(
					...
					ServiceUtils.getServices(interpreter.getQueryEnvironment(),	Class.forName("org.eclipse.acceleo.ale.core.interpreter.test.Service"))
					);
