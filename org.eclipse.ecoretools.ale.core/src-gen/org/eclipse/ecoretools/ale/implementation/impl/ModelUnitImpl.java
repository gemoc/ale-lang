 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.ecoretools.ale.implementation.impl.ModelUnitImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.eclipse.ecoretools.ale.implementation.impl.ModelUnitImpl#getServices <em>Services</em>}</li>
 *   <li>{@link org.eclipse.ecoretools.ale.implementation.impl.ModelUnitImpl#getClassExtensions <em>Class Extensions</em>}</li>
 *   <li>{@link org.eclipse.ecoretools.ale.implementation.impl.ModelUnitImpl#getClassDefinitions <em>Class Definitions</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ModelUnitImpl extends MinimalEObjectImpl.Container implements ModelUnit {
	/**
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ImplementationPackage.MODEL_UNIT__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ImplementationPackage.MODEL_UNIT__NAME:
				return getName();
