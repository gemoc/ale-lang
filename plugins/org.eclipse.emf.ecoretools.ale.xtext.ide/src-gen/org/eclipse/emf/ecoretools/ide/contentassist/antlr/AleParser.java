		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getRBlockAccess().getStatementsAssignment_2_0(), "rule__RBlock__StatementsAssignment_2_0");
					put(grammarAccess.getRBlockAccess().getStatementsAssignment_2_1(), "rule__RBlock__StatementsAssignment_2_1");
					...
					put(grammarAccess.getRExpressionAccess().getExpAssignment_0(), "rule__RExpression__ExpAssignment_0");
