		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getRSimpleStatementAccess().getAlternatives(), "rule__RSimpleStatement__Alternatives");
					put(grammarAccess.getRBlockStatementAccess().getAlternatives(), "rule__RBlockStatement__Alternatives");
					...
					put(grammarAccess.getRExpressionAccess().getExpAlternatives_0(), "rule__RExpression__ExpAlternatives_0");
					...
					put(grammarAccess.getROperationAccess().getGroup_5(), "rule__ROperation__Group_5__0");
					put(grammarAccess.getROperationAccess().getGroup_5_1(), "rule__ROperation__Group_5_1__0");
					...
					put(grammarAccess.getRBlockAccess().getGroup_2(), "rule__RBlock__Group_2__0");
					put(grammarAccess.getRBlockAccess().getGroup_2_0_0(), "rule__RBlock__Group_2_0_0__0");
					put(grammarAccess.getRBlockAccess().getGroup_2_1_0(), "rule__RBlock__Group_2_1_0__0");
					...
					put(grammarAccess.getRSwitchAccess().getGroup(), "rule__RSwitch__Group__0");
					put(grammarAccess.getRSwitchAccess().getGroup_2(), "rule__RSwitch__Group_2__0");
					put(grammarAccess.getRCaseAccess().getGroup(), "rule__RCase__Group__0");
					put(grammarAccess.getRCaseAccess().getGroup_1(), "rule__RCase__Group_1__0");
					put(grammarAccess.getExpressionAccess().getGroup(), "rule__Expression__Group__0");
					put(grammarAccess.getExpressionAccess().getGroup_1_0(), "rule__Expression__Group_1_0__0");
					put(grammarAccess.getExpressionAccess().getGroup_1_0_4(), "rule__Expression__Group_1_0_4__0");
					...
					put(grammarAccess.getExpressionAccess().getGroup_1_6(), "rule__Expression__Group_1_6__0");
					put(grammarAccess.getExpressionAccess().getGroup_1_7(), "rule__Expression__Group_1_7__0");
					put(grammarAccess.getExpressionAccess().getGroup_1_8(), "rule__Expression__Group_1_8__0");
					put(grammarAccess.getExpressionAccess().getGroup_1_9(), "rule__Expression__Group_1_9__0");
					...
					put(grammarAccess.getLiteralAccess().getGroup_6_2(), "rule__Literal__Group_6_2__0");
					put(grammarAccess.getLiteralAccess().getGroup_6_2_1(), "rule__Literal__Group_6_2_1__0");
					...
					put(grammarAccess.getRRootAccess().getImportsAssignment_3(), "rule__RRoot__ImportsAssignment_3");
					...
					put(grammarAccess.getRImportAccess().getNameAssignment_1(), "rule__RImport__NameAssignment_1");
					put(grammarAccess.getRImportAccess().getAliasAssignment_3(), "rule__RImport__AliasAssignment_3");
					put(grammarAccess.getRServiceAccess().getNameAssignment_1(), "rule__RService__NameAssignment_1");
					put(grammarAccess.getROpenClassAccess().getNameAssignment_2(), "rule__ROpenClass__NameAssignment_2");
					put(grammarAccess.getROpenClassAccess().getExtendsAssignment_3_1(), "rule__ROpenClass__ExtendsAssignment_3_1");
					put(grammarAccess.getROpenClassAccess().getExtendsAssignment_3_2_1(), "rule__ROpenClass__ExtendsAssignment_3_2_1");
					...
					put(grammarAccess.getROperationAccess().getTagAssignment_0(), "rule__ROperation__TagAssignment_0");
					...
					put(grammarAccess.getROperationAccess().getParamsAssignment_5_0(), "rule__ROperation__ParamsAssignment_5_0");
					put(grammarAccess.getROperationAccess().getParamsAssignment_5_1_1(), "rule__ROperation__ParamsAssignment_5_1_1");
					put(grammarAccess.getROperationAccess().getBodyAssignment_7(), "rule__ROperation__BodyAssignment_7");
					put(grammarAccess.getRTagAccess().getNameAssignment_1(), "rule__RTag__NameAssignment_1");
					...
					put(grammarAccess.getRAttributeAccess().getExpAssignment_5_1(), "rule__RAttribute__ExpAssignment_5_1");
					put(grammarAccess.getROppositeAccess().getNameAssignment_1(), "rule__ROpposite__NameAssignment_1");
					put(grammarAccess.getRVarDeclAccess().getTypeAssignment_0(), "rule__RVarDecl__TypeAssignment_0");
					put(grammarAccess.getRVarDeclAccess().getNameAssignment_1(), "rule__RVarDecl__NameAssignment_1");
					put(grammarAccess.getRVarDeclAccess().getExpAssignment_2_1(), "rule__RVarDecl__ExpAssignment_2_1");
					put(grammarAccess.getRAssignAccess().getTargetAssignment_0(), "rule__RAssign__TargetAssignment_0");
					put(grammarAccess.getRAssignAccess().getExpAssignment_2(), "rule__RAssign__ExpAssignment_2");
					put(grammarAccess.getRInsertAccess().getTargetAssignment_0(), "rule__RInsert__TargetAssignment_0");
					put(grammarAccess.getRInsertAccess().getExpAssignment_2(), "rule__RInsert__ExpAssignment_2");
					put(grammarAccess.getRRemoveAccess().getTargetAssignment_0(), "rule__RRemove__TargetAssignment_0");
					put(grammarAccess.getRRemoveAccess().getExpAssignment_2(), "rule__RRemove__ExpAssignment_2");
					put(grammarAccess.getRForEachAccess().getIteratorAssignment_2(), "rule__RForEach__IteratorAssignment_2");
					put(grammarAccess.getRForEachAccess().getCollectionAssignment_4(), "rule__RForEach__CollectionAssignment_4");
					put(grammarAccess.getRForEachAccess().getBlockAssignment_6(), "rule__RForEach__BlockAssignment_6");
					put(grammarAccess.getRCollectionAccess().getMinAssignment_0_1(), "rule__RCollection__MinAssignment_0_1");
					put(grammarAccess.getRCollectionAccess().getMaxAssignment_0_3(), "rule__RCollection__MaxAssignment_0_3");
					put(grammarAccess.getRCollectionAccess().getExpAssignment_1(), "rule__RCollection__ExpAssignment_1");
					put(grammarAccess.getRBlockAccess().getStatementsAssignment_2_0_0_0(), "rule__RBlock__StatementsAssignment_2_0_0_0");
					put(grammarAccess.getRBlockAccess().getStatementsAssignment_2_0_1(), "rule__RBlock__StatementsAssignment_2_0_1");
					put(grammarAccess.getRBlockAccess().getStatementsAssignment_2_1_0_0(), "rule__RBlock__StatementsAssignment_2_1_0_0");
					put(grammarAccess.getRBlockAccess().getStatementsAssignment_2_1_1(), "rule__RBlock__StatementsAssignment_2_1_1");
					put(grammarAccess.getRIfAccess().getCondAssignment_2(), "rule__RIf__CondAssignment_2");
					put(grammarAccess.getRIfAccess().getThenAssignment_4(), "rule__RIf__ThenAssignment_4");
					put(grammarAccess.getRIfAccess().getElseAssignment_5_1(), "rule__RIf__ElseAssignment_5_1");
					put(grammarAccess.getRWhileAccess().getCondAssignment_2(), "rule__RWhile__CondAssignment_2");
					put(grammarAccess.getRWhileAccess().getBlockAssignment_4(), "rule__RWhile__BlockAssignment_4");
					put(grammarAccess.getRSwitchAccess().getParamNameAssignment_2_0(), "rule__RSwitch__ParamNameAssignment_2_0");
					put(grammarAccess.getRSwitchAccess().getParamValAssignment_3(), "rule__RSwitch__ParamValAssignment_3");
					put(grammarAccess.getRSwitchAccess().getCasesAssignment_6(), "rule__RSwitch__CasesAssignment_6");
					put(grammarAccess.getRSwitchAccess().getOtherAssignment_9(), "rule__RSwitch__OtherAssignment_9");
					put(grammarAccess.getRCaseAccess().getGuardAssignment_0(), "rule__RCase__GuardAssignment_0");
					put(grammarAccess.getRCaseAccess().getMatchAssignment_1_1(), "rule__RCase__MatchAssignment_1_1");
					put(grammarAccess.getRCaseAccess().getValueAssignment_3(), "rule__RCase__ValueAssignment_3");
					put(grammarAccess.getRExpressionAccess().getExpAssignment(), "rule__RExpression__ExpAssignment");
					put(grammarAccess.getExpressionAccess().getNameAssignment_1_0_2(), "rule__Expression__NameAssignment_1_0_2");
					...
					put(grammarAccess.getExpressionAccess().getRightAssignment_1_6_2(), "rule__Expression__RightAssignment_1_6_2");
					put(grammarAccess.getExpressionAccess().getRightAssignment_1_7_2(), "rule__Expression__RightAssignment_1_7_2");
					put(grammarAccess.getExpressionAccess().getRightAssignment_1_8_2(), "rule__Expression__RightAssignment_1_8_2");
					put(grammarAccess.getExpressionAccess().getRightAssignment_1_9_2(), "rule__Expression__RightAssignment_1_9_2");
					put(grammarAccess.getNonLeftRecExpressionAccess().getExpAssignment_0_2(), "rule__NonLeftRecExpression__ExpAssignment_0_2");
					put(grammarAccess.getNonLeftRecExpressionAccess().getExpAssignment_1_2(), "rule__NonLeftRecExpression__ExpAssignment_1_2");
					put(grammarAccess.getNonLeftRecExpressionAccess().getIDAssignment_2_1(), "rule__NonLeftRecExpression__IDAssignment_2_1");
					put(grammarAccess.getNonLeftRecExpressionAccess().getLiteralAssignment_3_1(), "rule__NonLeftRecExpression__LiteralAssignment_3_1");
					put(grammarAccess.getNonLeftRecExpressionAccess().getCondAssignment_5_2(), "rule__NonLeftRecExpression__CondAssignment_5_2");
					put(grammarAccess.getNonLeftRecExpressionAccess().getThenAssignment_5_4(), "rule__NonLeftRecExpression__ThenAssignment_5_4");
					put(grammarAccess.getNonLeftRecExpressionAccess().getElseAssignment_5_6(), "rule__NonLeftRecExpression__ElseAssignment_5_6");
					...
					put(grammarAccess.getNonLeftRecExpressionAccess().getExpAssignment_6_5(), "rule__NonLeftRecExpression__ExpAssignment_6_5");
					...
					put(grammarAccess.getBindingAccess().getExpAssignment_3(), "rule__Binding__ExpAssignment_3");
					...
					put(grammarAccess.getLiteralAccess().getParamsAssignment_6_2_0(), "rule__Literal__ParamsAssignment_6_2_0");
					put(grammarAccess.getLiteralAccess().getParamsAssignment_6_2_1_1(), "rule__Literal__ParamsAssignment_6_2_1_1");
					put(grammarAccess.getLiteralAccess().getParamsAssignment_7_2_0(), "rule__Literal__ParamsAssignment_7_2_0");
					put(grammarAccess.getLiteralAccess().getParamsAssignment_7_2_1_1(), "rule__Literal__ParamsAssignment_7_2_1_1");
					put(grammarAccess.getTypeLiteralAccess().getTypeAssignment_4_2(), "rule__TypeLiteral__TypeAssignment_4_2");
