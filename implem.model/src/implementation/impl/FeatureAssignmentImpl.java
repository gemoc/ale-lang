 ...
 * </p>
 * <ul>
 *   <li>{@link implementation.impl.FeatureAssignmentImpl#getTargetExpression <em>Target Expression</em>}</li>
 *   <li>{@link implementation.impl.FeatureAssignmentImpl#getTargetFeature <em>Target Feature</em>}</li>
 *   <li>{@link implementation.impl.FeatureAssignmentImpl#getValueExpression <em>Value Expression</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FeatureAssignmentImpl extends StatementImpl implements FeatureAssignment {
	...
	public void setTargetExpression(String newTargetExpression) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ImplementationPackage.FEATURE_ASSIGNMENT__TARGET_EXPRESSION, oldTargetExpression, targetExpression));
	}
	...
	public void setValueExpression(String newValueExpression) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ImplementationPackage.FEATURE_ASSIGNMENT__VALUE_EXPRESSION, oldValueExpression, valueExpression));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ImplementationPackage.FEATURE_ASSIGNMENT__TARGET_EXPRESSION:
				return getTargetExpression();
			case ImplementationPackage.FEATURE_ASSIGNMENT__TARGET_FEATURE:
				return getTargetFeature();
			case ImplementationPackage.FEATURE_ASSIGNMENT__VALUE_EXPRESSION:
