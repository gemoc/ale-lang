...
import org.eclipse.emf.ecoretools.ale.core.metamodelembedding.AleInvocationDelegateFactory;
...
public class DelegateTest {
	...
	public void testInvoke() throws InvocationTargetException {
		...
		BasicEList<String> args = new BasicEList<>();
		args.add("event");
		fsm.eInvoke(execOp, args);
		
		assertEquals("FSM exec:" + lineSeparator() + "Hello world from First state" + lineSeparator(), outContent.toString());
		System.setOut(null);
	}
}
