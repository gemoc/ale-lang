...
public class BuildTest {
	...
	public void setup() {
		...
		parser = new BehaviorsParser(queryEnvironment);
	}
	
	@Test
	public void testClassExtension() {
		ParsedFile<ModelUnit> res = parse("input/structure/extendedClass.implem");
	...
	public void testAttributes() {
		ParsedFile<ModelUnit> res = parse("input/structure/attributes.implem");
		ModelUnit root = res.getRoot();
	...
	public void testMethod() {
		ParsedFile<ModelUnit> res = parse("input/structure/defMethod.implem");
		ModelUnit root = res.getRoot();
	...
	public void testImplem() {
		ParsedFile<ModelUnit> res = parse("input/structure/defImplem.implem");
		ModelUnit root = res.getRoot();
	...
	@Test
	public void testFor() {
		ParsedFile<ModelUnit> res = parse("input/structure/for.implem");
		ModelUnit root = res.getRoot();
	...
	public void testForEmpty() {
		ParsedFile<ModelUnit> res = parse("input/structure/forEmpty.implem");
		ModelUnit root = res.getRoot();
	...
	public void testWhile() {
		ParsedFile<ModelUnit> res = parse("input/structure/while.implem");
		ModelUnit root = res.getRoot();
	...
	@Test
	public void testIf() {
		ParsedFile<ModelUnit> res = parse("input/structure/if.implem");
		ModelUnit root = res.getRoot();
		...
		If ifStmt = (If) stmt2;
		Expression cond1 = ifStmt.getBlocks().get(0).getCondition();
		assertNotNull(cond1);
		...
		assertEquals(1, ifStmt.getBlocks().size());
		assertNotNull(ifStmt.getBlocks().get(0).getBlock());
		assertEquals(1, ifStmt.getBlocks().get(0).getBlock().getStatements().size());
		Statement stmt3 = ifStmt.getBlocks().get(0).getBlock().getStatements().get(0);
		assertTrue(stmt3 instanceof VariableAssignment);
		...
		If ifStmt2 = (If) stmt4;
		Expression cond2 = ifStmt2.getBlocks().get(0).getCondition();
		assertNotNull(cond2);
		assertTrue(cond2 instanceof BooleanLiteral);
		assertFalse(((BooleanLiteral)cond2).isValue());
		assertNotNull(ifStmt2.getBlocks().get(0).getBlock());
		assertEquals(1,ifStmt2.getBlocks().get(0).getBlock().getStatements().size());
		Statement stmt5 = ifStmt2.getBlocks().get(0).getBlock().getStatements().get(0);
	...
	public void testAllFeatures() {
		ParsedFile<ModelUnit> res = parse("input/structure/allFeatures.implem");
		ModelUnit root = res.getRoot();
	...
	public void testRuntimeClass() {
		List<ParsedFile<ModelUnit>> res = parser.parseFromFiles(asList("input/structure/newClass.implem"));
	...
	public void testExtends() {
		List<ParsedFile<ModelUnit>> res = parser.parseFromFiles(asList("input/structure/extends.implem","input/structure/extendedClass.implem"));
	...
	public void testContains() {
		List<ParsedFile<ModelUnit>> res = parser.parseFromFiles(asList("input/structure/contains.implem"));
		ModelUnit root = res.get(0).getRoot();
	...
	public void testUnique() {
		List<ParsedFile<ModelUnit>> res = parser.parseFromFiles(asList("input/structure/unique.implem"));
		ModelUnit root = res.get(0).getRoot();
	...
	public void testOpposite() {
		List<ParsedFile<ModelUnit>> res = parser.parseFromFiles(asList("input/structure/opposite.implem"));
		ModelUnit root = res.get(0).getRoot();
	...
	public void testTypeLiteral() {
		ParsedFile<ModelUnit> res = parse("input/structure/typeLiteral.implem");
		ModelUnit root = res.getRoot();
	...
	public void testAssign() {
		ParsedFile<ModelUnit> res = parse("input/structure/assign.implem");
		ModelUnit root = res.getRoot();
	...
	public void testInsert() {
		ParsedFile<ModelUnit> res = parse("input/structure/insert.implem");
		ModelUnit root = res.getRoot();
	...
	public void testInsertLocalVariable() {
		ParsedFile<ModelUnit> res = parse("input/structure/insertLocalVariable.implem");
		ModelUnit root = res.getRoot();
	...
	public void testRemovetLocalVariable() {
		ParsedFile<ModelUnit> res = parse("input/structure/removeLocalVariable.implem");
		ModelUnit root = res.getRoot();
	...
	public void testRemove() {
		ParsedFile<ModelUnit> res = parse("input/structure/remove.implem");
		ModelUnit root = res.getRoot();
	...
	public void testStatementError() {
		ParsedFile<ModelUnit> res = parse("input/structure/statementError.implem");
		ModelUnit root = res.getRoot();
	...
	public void testQualified() {
		IAleEnvironment environment = IAleEnvironment.fromPaths(asList("model/subPkg.ecore"),asList("input/structure/qualifiedType.implem"));
		List<ParsedFile<ModelUnit>> parsedSemantics = new BehaviorsParser(queryEnvironment).parse(environment.getMetamodels(), environment.getBehaviorsSources());
	...
	private ParsedFile<ModelUnit> parse(String fileName) {
		List<EPackage> metamodels = emptyList();
		HashSet<String> aleSourceFiles = new HashSet<>(asList(fileName));
		return parser.parse(metamodels, aleSourceFiles).get(0);
	}
}
